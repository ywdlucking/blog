		  		...
		  		<c:otherwise>
		  			<c:forEach var="blog" items="${blogList}">
		  				<li style="margin-bottom: 20px">
						  	...
						  	<span class="link"><a href="${pageContext.request.contextPath}/blog/articles/${blog.id }.html">http://ywd.ylovey.com/blog/articles/${blog.id }.html</a>&nbsp;&nbsp;&nbsp;&nbsp;发布日期：${blog.releaseDateStr }</span>
						</li>
		  			</c:forEach>
		  		</c:otherwise>
		  	</c:choose>
